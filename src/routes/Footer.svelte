<footer class="bg-white dark:bg-gray-900">
    <div class="container px-6 py-8 mx-auto">
        <div class="flex flex-col items-center text-center">
            <a href="#">
                <img class="w-auto h-12" src="https://www.matawebsite.com/images/blog/375_sveltejs_ramping_dan_elegan.png" alt="">
            </a>
        ...
        <div class="flex flex-col items-center sm:flex-row sm:justify-between">
            <p class="text-sm text-gray-500">©2024 <a class="text-blue-600" href="https://hy-tech.my.id/">Hy-Tech</a>. All Rights Reserved.</p>
